...
El [Stanford Institute for Human-Centered Artificial Intelligence](https://hai.stanford.edu/) publica anualmente el [AI Index Report](https://hai.stanford.edu/ai-index), reconocido como la fuente más comprehensiva y rigurosa de datos sobre el progreso de la inteligencia artificial. El reporte de 2024 —el más extenso hasta la fecha con más de 500 páginas— documenta tendencias que van desde el rendimiento técnico hasta el impacto económico, pasando por la regulación y la percepción pública de la IA.
...
### 3.1 Usar IA: la decisión inicial
...
### 3.2 Cómo usar la IA: niveles de sofisticación técnica
...
### 3.3 Para qué usar la IA: funciones y límites
