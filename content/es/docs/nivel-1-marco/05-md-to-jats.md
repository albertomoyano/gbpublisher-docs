...
El sistema de citas de Pandoc se basa en el Citation Style Language ([CSL](https://citationstyles.org/)), un estándar abierto desarrollado originalmente por Bruce D'Arcus y mantenido actualmente por una comunidad activa bajo el paraguas de [Zotero](https://www.zotero.org/) y [Mendeley](https://www.mendeley.com/) [32,33]. CSL permite definir estilos bibliográficos en un formato XML declarativo, con más de diez mil estilos disponibles en el repositorio oficial, incluyendo Vancouver, APA, Chicago, MLA y los estilos específicos de las principales revistas científicas internacionales.
...
Estas cuatro brechas definen con precisión el espacio de diseño de herramientas como gbpublisher al no reemplazar la cadena Pandoc --> JATS, sino extenderla con:

1. perfilado de plataforma;
2. gestión de metadatos complejos;
3. una interfaz intuitiva para equipos editoriales no técnicos.
